...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String url="https://api.hurriyet.com.tr/v1/articles?%25filter=Path%30%eq%30'/gundem/'";
        ...
        StringRequest stringRequest=new StringRequest(Request.Method.GET, url,
            ...
            @Override
            public void onErrorResponse(VolleyError error) {/*hata mesajı alacağımız yer*/
                Log.e("responseErr",error.getMessage());
                pd.dismiss();
            }
        })
        {
            //sağtık->generate->override methods->getHeaders()'ı seçiyoruz
            ...
            public Map<String, String> getHeaders() throws AuthFailureError {
                ...
                params.put("apikey","d4ddc83b51504ef1a899e1fb09ef0801");
                return params;
            }
        };
